...
RSpec.describe 'Attend Event', type: :system do
  ...
  it 'Attend new event' do
    user1 = User.create(email: 'testuser2@email.com', password: '123456')
    Event.create(description: 'Test even description 1', date: Date.parse('2022-04-23'), user_id: user1.id)
    visit root_path
    click_link_or_button 'Sign in'
    fill_in 'user[email]', with: user1.email
    fill_in 'user[password]', with: '123456'
